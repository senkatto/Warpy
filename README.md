...
<p align="center">
  <strong>Локальный VPN-клиент для Android и Windows с автоматическим распознаванием профилей, раздельным туннелированием и восстановлением соединения.</strong>
</p>
