...
Вопросы по Warpy, сообщения об ошибках и обратную связь можно отправить в Telegram: [@qostic](https://t.me/qostic).
Для сообщений об уязвимостях используйте порядок из [SECURITY.md](SECURITY.md).
