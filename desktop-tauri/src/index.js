...
const T = {
  ru: {
    ...
    invalidFormat: 'В буфере должен быть VPN-профиль или HTTPS-ссылка подписки',
  ...
  en: {
    ...
    invalidFormat: 'The clipboard must contain a VPN profile or an HTTPS subscription URL',
