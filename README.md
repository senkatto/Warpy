...
<p align="center">
  <strong>Простой, быстрый и понятный VPN клиент с упором на стабильную работу, быстрое переподключение и нормальную работу Telegram.</strong>
</p>
...
Warpy - локальный VPN-клиент для Android и Windows. Он импортирует ваши профили,
создаёт системный туннель и показывает подключение только после проверки трафика.
...
| | Android | Windows |
| --- | --- | --- |
| **Протоколы** | VLESS, Hysteria2, Trojan | VLESS, Hysteria2, Trojan |
...
1. Получите профиль VLESS, Hysteria2 или Trojan у провайдера либо со своего сервера.
2. Откройте Warpy и импортируйте ссылку, QR-код или подписку.
3. Выберите профиль и подключитесь. Зелёный статус появится после проверки маршрута.
